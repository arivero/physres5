...
Loop 33 makes the assignment target a same-source projection package.  A source
variable \(u_{\rm EW}\) must produce
\begin{equation}
  u_{\rm EW}\longmapsto
  \left(
...
\cite{Coquereaux1992Superconnections}.  In the present manuscript that source
supports the grading language for \(h_J\) and \(a_J\).  The ordered quotient in
