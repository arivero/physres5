...
The first local test is therefore entry-by-entry.  The adjoint entry should
come from the gauge-field fluctuation \(W\) along the singular gauge locus,
with the normalized ADE or adjoint invariant giving
\begin{equation}
  W\big|_{M_3}
  \quad\leadsto\quad
  \Sigma_{aa,J}^{G_2}=J .
...
\end{equation}
The off-diagonal product should come from the localized matter and
Higgs-bundle data,
\begin{equation}
  (\Phi,\rho_Q,f_Q)
  \quad\leadsto\quad
...
deformation coupling.  The order-parameter reference should come from the
