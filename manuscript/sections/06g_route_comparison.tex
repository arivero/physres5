...
\end{equation}
The available source equations fix the entry order.  The
...
The active proof spine is therefore
\begin{equation}
\begin{array}{ccc}
...
\end{equation}
The three open derivations pursued by this spine are: the CHM neutral-current entry
...
derivation from the source equations.  The entry tests now have two linked forms:
