...
\(\widehat\lambda=\lambda/\Lambda_J^2\).  Define
\begin{equation}
\begin{aligned}
...
\(\Lambda_J\), endpoint-normal conventions, ordered W/Z boundary map, and pole
map remain theorem data.  The parent KK-fixing notes sharpen the same issue into a single-source
