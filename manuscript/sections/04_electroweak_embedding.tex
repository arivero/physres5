...
and complex-pole matching data.  The tree-level analogy is recovered by
replacing the pole masses with Eq.~\eqref{eq:tree-masses} and setting the
matching remainder to its tree-level value.  Sec.~\ref{sec:pole} and
Appendix~\ref{app:target-pole-placement} state the pole-matching obligation.
