...
\paragraph*{Section status.}  This section is source-supported for the dual-model, open-string, and brane background.  The endpoint determinant is conjectural and states the calculation owed.
