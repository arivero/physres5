...
## QFT, electroweak, and Higgs sector

- `05_Tong_Quantum_Field_Theory_notes.pdf` — free fields, Casimir effect, particles, spinors, QED.
- `07_Tong_Standard_Model_notes.pdf` — Poincare representations, gauge invariance, anomalies, Higgs mechanism, electroweak interactions.
...
- `39_Kumar_Taylor_String_Universality_Six_Dimensions_0906.0987.pdf` — six-dimensional supergravity/string consistency and string universality constraints.

## Kaluza-Klein, supergravity, M-theory, and G2
...
- `15_Freedman_VanProeyen_Ingredients_of_Supergravity_1106.1097.pdf` — supersymmetry and supergravity ingredients.
- `24_Acharya_Witten_Chiral_Fermions_G2_hep-th-0109152.pdf` — chiral fermions from G2 singularities and GUT representations.
  - Loop 40 extra note review read pages 21--27.  The fragment records
...
## GUT and flavor algebra

- `16_Baez_Huerta_Algebra_of_GUTs_0904.1556.pdf` — representation-theoretic Standard Model, SU(5), Spin(10), Pati-Salam.
- `17_Britto_E6_GUT_2102.13465.pdf` — E6 GUT construction and representations.

## Spectral geometry and lens-space side calculations

- `26_Lauret_Spectrum_p_forms_Lens_Spaces_1604.02471.pdf` — p-form spectra on lens spaces.
- `27_DaSilva_Spectrum_Laplacian_Lens_Spaces_2411.03525.pdf` — Laplacian spectrum and eigenspace dimensions for functions on lens spaces.
- `28_Henkel_Lauret_Hodge_Laplacian_1_forms_Homogeneous_3_spheres_2605.05406.pdf` — Hodge-Laplacian on 1-forms of homogeneous 3-spheres; AI-assisted mathematical proof case study.
...
## Electroweak-couplings route (alpha, radion, gauge-Higgs) -- added 2026-05-22 from physres6
...
- `50_Coquereaux_Algebraic_Superconnections_SU2_1_Electroweak_1992.pdf` — \(SU(2|1)\) algebraic superconnection formalism for electroweak symmetry breaking and Higgs fields as part of a generalized connection.
  ...
  - Loop 40 web audit: EUDML/Numdam confirms the local RCP25 talk metadata and
    reference list; ScienceDirect records the related 1991 PLB article by
