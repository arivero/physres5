...
\(\widehat\Sigma_{aa,2}^{G_2,{\rm can}}=2\).  Its flow-overlap product,
...
\(\Sigma_{ha}\Sigma_{ah}=J\) & stretched string or endpoint overlap & boundary scalar vev, \(A_5/\pi_i\) equation, and modified product; open product normalization & localized matter at \(df_Q=0\), flow data, and point-support metric\\
