...
\end{equation}
The original note emphasized the proximity of this number to the mass-shell weak angle and motivated the operator through Casimir invariants and high-spin behavior \cite{Rivero2006}.  In this paper Eq.~\eqref{eq:intro-devries} is used as a descriptive spectral clue.  The central question asks which physical object carries the square root in Eq.~\eqref{eq:intro-secular}, and why that object is read at the low-energy W/Z pole ratio.
