...
The SO(32)-flavor idea is therefore an organizing boundary sector.  In an endpoint language it may label external or internal flavor degrees of freedom, Chan--Paton-like data, or a bookkeeping algebra for fermion multiplicities.  A useful representation audit starts with the proposed branching data
\begin{equation}
  16=(5,3)+(1,1),
  \qquad
...
\end{equation}
These equations define a representation target.  They become a string
completion only after the endpoint or orientifold construction supplies the
gauge group, projection, massless spectrum, and coupling to the electroweak
operator.  Its required checks are concrete:
\begin{enumerate}
