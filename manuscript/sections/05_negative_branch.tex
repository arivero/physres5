...
\end{equation}
The first lies near the electroweak vacuum scale convention \(v/\sqrt2\), and the second lies near the Higgs pole-mass range in the seed arithmetic of the project.  They are unresolved branch-scale identifications.  The secular equation points at the vector pole ratio and at the scalar side of electroweak symmetry breaking at the same time.
...
The negative root changes the character of the clue.  The positive branch by itself would be a ratio of two selected positive eigenvalues.  The full quadratic gives a paired object: a pole-ratio candidate and a scalar-side candidate arise from one secular equation.  This pairing is the conceptual reason to continue the project.  A dynamical theory that produces Eq.~\eqref{eq:intro-secular} has to say what both branches mean in the same basis.

The two-root structure can be stated as a spectral ledger,
\begin{equation}
  \mathcal M_J
  \longrightarrow
  \left\{
...
The electroweak ray also supplies a useful consistency check.  Taking the radial vacuum coordinate toward the symmetric point should collapse the vector masses together with the Higgs order parameter.  The DeVries ratio can remain as a projective direction in coupling or spectral space.  A scalar interpretation of \(x_-\) should respect this ray structure by scaling with the radial data or by controlling the deformation that sets the radial scale.
...
These maps give the negative branch a practical role in route selection.  A candidate route that produces the positive-branch quotient and leaves the negative eigenvector with a scalar or deformation interpretation becomes stronger.  A route that produces a positive branch while assigning the negative branch to an unrelated auxiliary variable still teaches the manuscript where the physical claim should stop.
