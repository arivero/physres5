...
Let \(J=s(s+1)\). Define the dimensionless roots

\[
x_{\pm}(J)=\frac{-J\pm\sqrt{J^2+4J}}{2}.
\]

The positive branch is used for the vector-boson mass comparison:

\[
\frac{M_W^2}{M_Z^2}\simeq \frac{x_+(3/4)}{x_+(2)},
\qquad
...
\[
\sin^2\theta_{\rm pole},\qquad
\sin^2\theta_{\rm on-shell},\qquad
\hat s^2(\mu)_{\overline{\rm MS}},\qquad
...
- A clean derivation of the secular equation from Casimir data and its high-spin or trace constraints.
- A scheme-safe comparison to the W/Z pole-mass observable.
- A section explaining why the W and Z entries are \(J=3/4\) and \(J=2\), or a formal statement that this is the primary remaining conjecture.
- An analytical treatment of the negative branch and its possible Higgs/order-parameter meaning.
